...
philly_crime22 <- read_csv("data/source/recent/phillycrime22_maiatemp.csv") %>% janitor::clean_names()
philly_crime23 <- read_csv("data/source/recent/phillycrime23_maiatemp.csv") %>% janitor::clean_names()
