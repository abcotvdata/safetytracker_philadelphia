...
![<popupchatter>Updated `r format(Sys.time(), '%B %d, %Y')` by the 6ABC Data Team</popupchatter>](https://github.com/abcotvdata/safetytracker_philadelphia/raw/main/docs/banner_placeholder.png)
...
philadelphia_murder_map <- leaflet(murders_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
  htmlwidgets::onRender("function(el, x) {
L.control.zoom({ position: 'topright' }).addTo(this)
}") %>%
  setView(-75.165, 39.9526, zoom = 12) %>% 
