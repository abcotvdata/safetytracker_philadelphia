...
past_philly_crime <- rbind(read_csv("data/source/annual/phillycrime19"), read_csv("data/source/annual/phillycrime20"), read_csv("data/source/annual/phillycrime21"), read_csv("data/source/annual/phillycrime22")[,4:18])
