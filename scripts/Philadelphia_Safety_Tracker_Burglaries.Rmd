...
<h2>ABC13's data team is tracking crime and safety across Philadelphia and in your neighborhood.<br>You can choose which crime to examine: <select onchange="window.location=this.value">
