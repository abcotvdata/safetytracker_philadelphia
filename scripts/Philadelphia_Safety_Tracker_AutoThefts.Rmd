...
philadelphia_autotheft_map <- leaflet(autothefts_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.25, zoomDelta=0.25)) %>%
...
<iframe title="2023 property crime rate comparison in select major cities" aria-label="Bar Chart" id="datawrapper-chart-QBZpX" src="https://datawrapper.dwcdn.net/QBZpX/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="580" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
